...
import six.com.crawler.work.downer.exception.UnknowHttpStatusDownerException;
import six.com.crawler.work.downer.exception.IoDownerException;
import six.com.crawler.work.downer.exception.DataTooBigDownerException;
...
public class HttpClient implements InitializingBean {
	...
	public HttpResult executeHttpUriRequest(HttpUriRequest httpRequest) throws AbstractHttpException {
		...
		try {
			...
			throw new IoDownerException("execute request[" + url + "] err", e);
		} catch (IOException e) {
			throw new IoDownerException("execute request[" + url + "] err", e);
		} finally {
			try {
