...
*/
public class TjfdcProjectInfoWorker extends HtmlCommonWorker{

	private RedisWorkQueue tjfdcPresaleInfoQueue;
	private Map<String,String> fieldMap;
	
	public TjfdcProjectInfoWorker(String name, AbstractSchedulerManager manager, Job job, Site site, WorkQueue stored) {
	...
	protected void insideInit() {
		tjfdcPresaleInfoQueue = new RedisWorkQueue(getManager().getRedisManager(),
				"tjfdc_presale_info");
