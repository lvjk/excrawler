 ...
 *
 */
public class DLDCLSProjectInfoWorker extends AbstractCrawlWorker{
	...
	protected void insideInit() {
		...
		unitInfoQueue = getManager().getWorkSpaceManager().newWorkSpace("dldc_ls_unit_info", Page.class);
	}
	...
	protected void onComplete(Page doingPage, ResultContext resultContext) {
		...
		String URL="http://218.25.171.244/InfoLayOut_LS/Config/LoadProcToXML.aspx?pid=Arty_XSLPXX&csnum=3&cn1=ysxkid&cv1="+cv1+"&cn2=PageIndex&cv2=1&cn3=PageSize&cv3=10000";
