 ...
 *
 */
public class DLDCGXUnitInfoWorker extends AbstractCrawlWorker{
	...
	protected void insideInit() {
		...
		roomStateQueue = getManager().getWorkSpaceManager().newWorkSpace("dldc_gx_room_state_info", Page.class);
	}
	...
	protected void onComplete(Page doingPage, ResultContext resultContext) {
		...
		for (int i = 0; i < unitIds.size(); i++) {
			...
			String URL="http://218.25.171.244/InfoLayOut_GX/Config/GetUrlData.aspx?url=http://192.168.10.11:81/RealtyOutside_gx/ArtyWebPage/XmlData/XmlRoom.aspx?roomsPerRow=4&lpid="+unitId;
