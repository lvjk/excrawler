...
public class YtfcjyprojectListInfoWorker extends AbstractCrawlWorker {
	...
	// private Page buildPage(int pageIndex, String refererUrl, Map<String,
	// Object> paramMap) {
	//
	// Page page = new Page(getSite().getCode(), 1, projectListUril,
	// projectListUril);
	...
	protected void insideInit() {
		// 初始化项目队列
		projectInfoQueue = getManager().getWorkSpaceManager().newWorkSpace("ytfcjy_project_info", Page.class);
